(function (factory) {
  ...
  function CropAvatar($element) {
    ...
    this.$modalHtml = "<div class=\"modal fade\" id=\"avatar-modal\" aria-hidden=\"true\" aria-labelledby=\"avatar-modal-label\" role=\"dialog\" tabindex=\"-1\">"
                    ...
                    + "              <h4 class=\"modal-title\" id=\"avatar-modal-label\">Choose an image<\/h4>"
                    + "            <\/div>"
                    ...
                    + "                  <label for=\"avatarInput\">Search here<\/label>"
                    ...
                    + "                  <\/div>"
                    + "                  <div class=\"col-md-3\">"
                    + "                    <button type=\"submit\" class=\"btn btn-primary btn-block avatar-save\">Use Photo<\/button>"
                    + "                  <\/div>"
                    + "                <\/div>"
                    + "              <\/div>"
                    + "            <\/div>"
  ...
  CropAvatar.prototype = {
    ...
    submitDone: function (data) {
      ...
      if ($.isPlainObject(data) && data.state === 200) {
        ...
        this.alert('Failed to crop the image');
      }    
    },
